...
- **Matthew David Phelps**. Author.

- **Nicolai Skov Johnsen**. Author.

- **Henrik Sparre Spiegelhauer**. Author.

- **ABIU (Anders Bilgrau)**. Author.

- **Simon Clancy**. Author.

- **Christian Haargaard Olsen**. Author, maintainer.
...
Source:
[`DESCRIPTION`](https://github.com/hta-pharma/chefStats/blob/feature/CRAN_submission/DESCRIPTION)
