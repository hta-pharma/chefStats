...
Calculate the number of subjects with events by treatment and stratum.

## Usage

``` r
n_subj_event(dat, event_index, cell_index, subjectid_var, ...)
```
...
A data.table containing the number of subjects with events for the given
combination of treatment and stratum.
...
#>                            <char>     <char> <char> <num>
#> 1: Number of subjects with events       <NA>      n     2
```
