...
``` r
p_subj_event(dat, event_index, cell_index, subjectid_var, ...)
```
...
A data.table containing the percentage of subjects with events for the
given combination of treatment and stratum
